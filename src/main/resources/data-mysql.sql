...
-- ROLES - Jogosultságok
-- ========================================
INSERT INTO roles (name, desciption) VALUES
...
INSERT INTO reviews (user_id, room_id, rating, comment, created_at) VALUES
                                                                        (2, 3, 5, 'Fantasztikus szoba! Nagyon tiszta és kényelmes.', NOW()),
                                                                        (3, 5, 4, 'Jó szoba, érme megfelel.', NOW()),
                                                                        (4, 1, 5, 'Nagyobb mint vártam!', NOW()),
